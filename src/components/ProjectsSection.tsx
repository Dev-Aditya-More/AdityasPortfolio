...
const androidProjects = [
  ...
  },
  {
    ...
    description:
      "Simple weather forecast app with a clean interface and location-based updates.",
    longDesc:
      "Displays real-time weather data via OpenWeatherMap API and integrates location services with Geocoder.",
  ...
  },
  {
    ...
    longDesc:
      "Exciting new Jetpack Compose and Kotlin projects are on the way. Stay tuned!",
    image:
      "https://images.unsplash.com/photo-1590479773265-7464e5d48118?q=80&w=1170&auto=format&fit=crop",
    tags: ["Coming Soon"],
    github: null,
  },
];
...
const devopsProjects = [
  {
    ...
    longDesc:
      "Working on advanced DevOps automation, cloud-native solutions, and infrastructure optimization projects. Stay tuned for updates!",
    image:
      "https://images.unsplash.com/photo-1590479773265-7464e5d48118?q=80&w=1170&auto=format&fit=crop",
    tags: ["Coming Soon"],
    github: null,
    ...
    <>
      <div className="relative inline-block" style={{ zIndex: 1 }}>
        ...
        >
          ...
          <svg
            className={`w-3 h-3 opacity-95 transform transition-transform duration-200 ${
              open ? "rotate-180" : ""
            }`}
            viewBox="0 0 20 20"
            fill="currentColor"
              ...
              >
                ...
                >
                  ...
                  >
                    <path
                      d="M1 11L12 1L23 11"
                      stroke="var(--muted-foreground, #0f1724)"
                      strokeWidth="1.6"
                      strokeLinecap="round"
