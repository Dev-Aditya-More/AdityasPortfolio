...
const androidProjects = [
  {
    ...
    download: 'https://github.com/Dev-Aditya-More/Taskly/releases/download/v1.0.0/app-release.apk'
  },
  {
    ...
    download: 'https://github.com/Dev-Aditya-More/PokeVerse/releases/download/v1.0.1/app-release.apk'
  },
  {
    ...
    download: 'https://github.com/Dev-Aditya-More/BreezyTheApp/releases/download/v1.0.0/app-release.apk'
  },
  {
